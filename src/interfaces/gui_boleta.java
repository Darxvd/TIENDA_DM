...
public class gui_boleta extends JInternalFrame {
	...
	private gui_busc_cliente cliente = new gui_busc_cliente();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					gui_boleta frame = new gui_boleta();
	...
	public gui_boleta() {
		...
		setFrameIcon(new ImageIcon("D:\\JAVA\\JAVA DESKTOP\\PROYECTO_D_Y_T\\imagenes\\factura (2).png"));
		...
		getContentPane().setLayout(null);
		{
			...
			lblNewLabel.setBounds(0, 0, 519, 39);
		...
		{
			lblNewLabel_2 = new JLabel("Datos del Cliente");
		...
		}
		{
			...
			textField_2.setBounds(71, 140, 387, 20);
